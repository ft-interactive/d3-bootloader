...
var envGlobal = typeof self !== 'undefined' ? self : commonjsGlobal;
/*
 * Simple Symbol() shim
 */
...
function nodeFetch (url, authorization, integrity, asBuffer) {
  ...
  return new Promise(function (resolve, reject) {
    fs$$1.readFile(url, function(err, data) {
      if (err) {
        return reject(err);
      }
      else {
...
else if (typeof commonjsRequire !== 'undefined' && typeof process !== 'undefined')
...
var nodeRequire;
if (typeof commonjsRequire !== 'undefined' && typeof process !== 'undefined' && !process.browser)
  nodeRequire = commonjsRequire;
...
var defaultMap = {
  ...
  'd3-array': 'https://d3js.org/d3.v5.js',
  'd3-axis': 'https://d3js.org/d3.v5.js',
  'd3-brush': 'https://d3js.org/d3.v5.js',
  'd3-chord': 'https://d3js.org/d3.v5.js',
  'd3-collection': 'https://d3js.org/d3.v5.js',
  'd3-color': 'https://d3js.org/d3.v5.js',
  'd3-dispatch': 'https://d3js.org/d3.v5.js',
  'd3-drag': 'https://d3js.org/d3.v5.js',
  'd3-dsv': 'https://d3js.org/d3.v5.js',
  'd3-ease': 'https://d3js.org/d3.v5.js',
  'd3-force': 'https://d3js.org/d3.v5.js',
  'd3-format': 'https://d3js.org/d3.v5.js',
  'd3-geo': 'https://d3js.org/d3.v5.js',
  'd3-hierarchy': 'https://d3js.org/d3.v5.js',
  'd3-interpolate': 'https://d3js.org/d3.v5.js',
  'd3-path': 'https://d3js.org/d3.v5.js',
  'd3-polygon': 'https://d3js.org/d3.v5.js',
  'd3-quadtree': 'https://d3js.org/d3.v5.js',
  'd3-quarterly': 'https://rawgit.com/ft-interactive/d3-quarterly/master/index.js',
  'd3-queue': 'https://d3js.org/d3.v5.js',
  'd3-random': 'https://d3js.org/d3.v5.js',
  'd3-fetch': 'https://d3js.org/d3.v5.js',
  'd3-scale': 'https://d3js.org/d3.v5.js',
  'd3-selection-multi': 'https://unpkg.com/d3-selection-multi@1.0.1',
  'd3-selection': 'https://d3js.org/d3.v5.js',
  'd3-shape': 'https://d3js.org/d3.v5.js',
  'd3-time-format': 'https://d3js.org/d3.v5.js',
  'd3-time': 'https://d3js.org/d3.v5.js',
  'd3-timer': 'https://d3js.org/d3.v5.js',
  'd3-transition': 'https://d3js.org/d3.v5.js',
  'd3-voronoi': 'https://d3js.org/d3.v5.js',
  'd3-zoom': 'https://d3js.org/d3.v5.js',
